              ...
              <div className="w-full flex flex-col">
                <div className="w-full flex flex-col sm:flex-row justify-between items-stretch mt-2 gap-2">
                  ...
                  <button
                    ...
                    onClick={() => [setApply(true), console.log("code", code)]}
                  >
                    APPLY
                  </button>
                </div>
                  ...
                  <>
                    <div className="w-full flex flex-col gap-3 mt-3">
                      <h1 className="text-[#26903B] font-medium">
                        Promo code "{code}" applied successfully! Applied to 2
            ...
            {apply == true ? (
              <>
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mt-4">
                  ...
                  <div className="flex gap-2">
                    <button className="px-3 py-1 bg-white border-2 border-black text-black rounded-[7px] font-medium">
                      BACK
                    </button>
                    <button className="bg-gradient-to-r from-[#27963D] to-[#134323] text-white px-4 py-1.5 rounded-[7px] font-medium">
                      NEXT
                    </button>
                  </div>
                </div>
              ...
              <div className="flex justify-end mt-4">
                <div className="flex items-center gap-1">
                  <span className="font-bold">Total:</span>
                  <span className="font-bold text-xl">EUR 300</span>
                  <span className="text-xs text-[#808080]">Incl. 19% VAT</span>
                </div>
              </div>
            )}
            ...
            <div className="text-xs text-gray-700 space-y-4 mb-6 mt-6">
              <div className="flex items-start gap-2">
                ...
                <p>
                  ...
                  not be admitted, and admission to the exhibition is restricted
                  to trade and business professionals only, and students above
                  16 and below 18 can attend only if accompanied by school or
                  faculty member <span className="text-[#DF1E3B]">*</span>
                </p>
              </div>
              <div className="flex items-start gap-2">
                <input type="checkbox" className="mt-1" />
